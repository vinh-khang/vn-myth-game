    ...
    return (
        <>
            <div className="homepage-container noselect">
                <div className="homepage-content" style={{ background: 'rgb(82, 82, 82)' }}>
                    <div className="login-background col-12">
                        <div className="login-form">
                            <div className="login-logo">
                                <img className="img-fluid logo" src={Logo} alt="Generic placeholder" draggable={false} />
                            </div>
                            ...
                            <div className="row mt-4 gap-2 justify-content-center">
                                <button className="btn btn-danger col-2 icon" type="button" onClick={() => loginWithGG()}><i className="fa-brands fa-google"></i></button>
                                <button className="btn btn-primary col-2 icon" type="button" onClick={() => loginWithFB()}><i className="fa-brands fa-facebook-f"></i></button>
                            </div>
                        </div>
